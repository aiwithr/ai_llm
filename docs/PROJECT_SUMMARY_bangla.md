...
ইউজার কোয়েরি
     ...
     ▼
┌─────────────┐
│ রিট্রিভার  │ ─────▶ ভেক্টর ডাটাবেস
└─────────────┘
     │
     ▼
┌─────────────┐
│  অগমেন্ট   │ ─────▶ প্রম্পটে কনটেক্সট যোগ
└─────────────┘
     │
     ▼
┌─────────────┐
...
│                   HR অ্যাসিস্ট্যান্ট                   │
├─────────────┬─────────────┬─────────────────────────┤
│ HR ম্যানেজার │ HR চ্যাটবট │ সেলস ফানেল AI ক্লোজার   │
├─────────────┼─────────────┼─────────────────────────┤
│ ছুটি API    │ পলিসি DB   │ CRM ইন্টিগ্রেশন         │
│ ক্যালেন্ডার │ বেনিফিট   │ লিড ডাটাবেস             │
│ টিম ম্যানেজমেন্ট │ প্রসিডিউর │ ইমেইল/টেলিফোনি        │
└─────────────┴─────────────┴─────────────────────────┘
                    │
                    ▼
              ┌──────────┐
