...
|> Last updated: 2026-06-12 — A6 complete (3 case-study pages + nav + AUDIT/ROADMAP log update); A7 next; rules: `site_url` = live site, `repo_url` = canonical project repo, project name = **AI Work Flow for Business**
