...
|> Last updated: 2026-06-07 — A5 complete (commits `5183a97` English summary, `b2aeb66` Bangla link fix, plus `356be4b` orphan removal and `085f9fb` Bangla summary Mermaid); A6 next; rules: `site_url` = live site, `repo_url` = canonical project repo, project name = **AI Work Flow for Business**
