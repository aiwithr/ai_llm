...
This file has been moved out of the MkDocs nav. It captures the state of the docs at the end of **Phase A1** (initial cleanup and gap audit, 2026-06-06). Since then the project has progressed through A2 (new IA), A3 (Adoption sub-pages), A4 (Architecture sub-pages), A5 (English summary mirror), and follow-up fixes (spec2code bilingual split, overview.md language split, broken anchors).

**It is kept on disk for historical reference only.** The live audit and roadmap are:

- Current roadmap: [../ROADMAP.md](../ROADMAP.md)
- This archive lives at docs/archive/AUDIT-2026-06-06.md and is intentionally **not** linked from the site nav.
