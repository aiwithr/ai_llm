...
> **সময়:** ৪–৮ সপ্তাহ, ১টা ওয়ার্কফ্লো, ২–৩ জন ইঞ্জিনিয়ার + ১ জন অপস/ডেভঅপ্স।
> **বের-হওয়ার মানদণ্ড:** প্রোডাকশনে ডিপ্লয় হয়েছে, রানবুক আছে, রোলব্যাক পরীক্ষিত, অবজার্ভেবিলিটি চলছে।

[পাইলট](pilot.md)-এ তোমার কাছে একটা শ্যাডো-মোড স্ক্রিপ্ট আছে যেটা ১ সপ্তাহ ধরে বার পূরণ করে এবং একটা "হ্যাঁ" সিদ্ধান্ত আছে। বিল্ড সেই ল্যাপটপ স্ক্রিপ্টটাকে পরিষেবায় রূপান্তর করে — এমন কিছু যেটা ৯০ দিন ধরে চলে, ৫+ ব্যবহারকারী ব্যবহার করে, এবং একজন ইঞ্জিনিয়ার ছুটিতে থাকলেও ভাঙে না।
...
একটা সহজ উদাহরণ দিই। [পাইলট](pilot.md)-এ তুমি হয়তো ISP টিকিট ট্রায়াজের একটা প্রম্পট লিখেছ, LM Studio-তে Qwen ১.৫B মডেল চালিয়েছ, আর ৪০০টা টিকিটের ওপর শ্যাডো মোডে টেস্ট করেছ। তোমার ল্যাপটপে সেটা চলছে, ফলাফল সঠিক, আর তুমি খুশি। কিন্তু সেই মুহূর্তে তুমি ছাড়া আর কেউ সেটা চালাতে পারে না — তুমি ছাড়া অন্য কেউ জানে না কোন পোর্টে মডেল চলছে, কোন ভার্সনের LM Studio ব্যবহার হচ্ছে, কোন প্রম্পট ফাইলটা আসল। তুমি ছুটিতে গেলে সিস্টেম বন্ধ। ল্যাপটপ হারিয়ে গেলে পুরো প্রজেক্ট শেষ। বিল্ডের কাজ হলো এই "তুমি ছাড়া কিছু না" অবস্থাটাকে ভেঙে দেওয়া — যাতে সিস্টেমটা তোমার চেয়ে বেশিদিন বাঁচে।

---

## ওয়ার্কস্ট্রিম ১ — কোড

লক্ষ্য: পাইলটের স্ক্রিপ্টকে এমন কোডবেসে রূপান্তর করা যেটা টিমের বাকি অংশ বুঝতে পারে, পরীক্ষা করতে পারে, আর প্রয়োজনে পরিবর্তন করতে পারে। তুমি একা সেটা লিখেছ, কিন্তু কাল তোমার সহকর্মী সেটা চালাবে — সেই সহকর্মীর চোখ দিয়ে লিখতে হবে।

**প্যাকেজিং।** প্রজেক্টে Pydantic মডেল থাকবে (চুক্তি), একটা Dockerfile থাকবে (রানটাইমের জন্য), একটা `pyproject.toml` বা `requirements.txt` থাকবে (নির্ভরতা পিন করা), আর একটা "এটা কী" README থাকবে। পাইলটে তোমার প্রম্পট আর LM Studio URL-ই যথেষ্ট ছিল। বিল্ডে সেটা ভাঙে — কারণ কালকে তোমার সহকর্মী যখন কোড ওপেন করবে, তখন সে জানবে না তুমি কোন ভার্সনের Pydantic ব্যবহার করেছ, কোন prompt ফাইল আসল, কোন output schema enforce হচ্ছে। প্যাকেজিং মানে এই "জানা" জিনিসগুলোকে ফাইলে লিখে রাখা — যাতে ডকুমেন্টেশন না পড়েও বোঝা যায়।

**৩-স্তরের টেস্ট।**

প্রথম স্তর হলো ইউনিট — যেকোনো pure ফাংশন (যেমন কনফিডেন্স থ্রেশহোল্ড, প্রায়োরিটি ক্যাপ)। দ্রুত, কোনো LLM ছাড়া। মিলিসেকেন্ডে রান হয়, মডেলের দরকার নেই, আর ভুল হলে সাথে সাথে ধরা পড়ে। দ্বিতীয় স্তর হলো চুক্তি — প্রম্পট-আউটপুট পার্সিং Pydantic-এর বিরুদ্ধে। "আউটপুট TriageResult-এ ভ্যালিডেট হয়", "প্ল্যাটিনাম + আউটেজ P1 বা P2 দেয়" — এই ধরনের ব্যবসায়িক নিয়ম চুক্তি টেস্টে থাকে। তৃতীয় স্তর হলো রিগ্রেশন — পাইলটের ৫০-উদাহরণের শ্যাডো সেট, সংরক্ষিত, প্রতিটা রিলিজের আগে রান করে, ব্যর্থতার ধরন গণনা করে। এই ৫০টা উদাহরণই হলো তোমার "আগে যা কাজ করেছ, এখনো কাজ করছে" প্রমাণ।

**CI।** GitHub Actions (বা যেটাই আছে) এখন রান করে: লিন্ট, ইউনিট টেস্ট, চুক্তি টেস্ট, রিগ্রেশন ইভ্যাল। মার্জ করতে গেলে সবুজ। কোনো "আমি ম্যানুয়ালি রান করেছিলাম, কাজ করে" না। "CI সবুজ" ছাড়া কোনো PR মার্জ হয় না — এটাই নিয়ম। একটা ভাঙা প্রম্পট, একটা হারানো Pydantic ফিল্ড, একটা বদলে যাওয়া মডেল আচরণ — সব ধরা পড়ে কোড মার্জ হওয়ার আগেই।

একটা ছোট উদাহরণ দিই। পাইলটে তোমার একটা ফাংশন ছিল `normalize_priority(raw: str) -> int` যেটা মডেলের "P3" আউটপুটকে ইন্টিজারে কনভার্ট করত। পাইলটে তুমি ধরে নিয়েছ মডেল সবসময় "P1", "P2", "P3", "P4" দেয়। বাস্তবে একদিন মডেল "P-3" দিল, ড্যাশ সহ। ফাংশন ক্র্যাশ করল। পাইলটে তুমি হয়তো হাতে ঠিক করেছ। বিল্ডে এই কেসটা ইউনিট টেস্টে ঢোকানো হলো, CI-তে ধরা পড়ল, আর কালকে কেউ "P-3" দিলে সিস্টেম নিজেই সামলাবে।
...
**অপশন B — vLLM কন্টেইনার।** মডেলকে একটা OpenAI-সামঞ্জস্যপূর্ণ HTTP API-তে পরিবেশন করে, Docker-এ প্যাকেজড। সুবিধা: ভালো থ্রুপুট, GPU-বান্ধব, স্ট্যান্ডার্ড অপস টুলিং (Kubernetes, Helm) কাজ করে। অসুবিধা: নতুন ইনফ্রা পাথ, vLLM-নির্দিষ্ট কনফিগারেশন, "কেন এটা সব LM Studio না" প্রশ্ন। ≥ ৫০ সমকালীন ব্যবহারকারী বা ≥ ২ ওয়ার্কফ্লো চললে বিবেচনা করো।
...
1. **ল্যাটেন্সি p50 + p95 (প্রতিটা ওয়ার্কফ্লোর জন্য)।** p50 বলে কত দ্রুত সাধারণ কেস, p95 বলে কত ধীর খারাপ কেস। মডেল + প্রম্পট + পার্সিং সহ। সময়ের সাথে p95 বাড়তে থাকলে বুঝবে কিছু আটকাচ্ছে — হয় মডেল স্লো, হয় prompt লম্বা হচ্ছে, হয় ইনপুট বড় হচ্ছে।
2. **অ্যাগ্রিমেন্ট রেট (স্যাম্পল্ড)।** প্রতিটা ১০০০ ইনভোকেশনে ১০টা মানব-পরীক্ষিত ফলাফল — মানে একজন মানুষ বসে ১০টা কেস দেখে বলে মডেলের উত্তর ঠিক ছিল কিনা। বেসলাইনের চেয়ে ১০ পয়েন্ট ড্রপ হলে পেজ। এটা ধরে রাখা সস্তা কিন্তু মূল্যবান — কারণ মডেল ভালো উত্তর দিচ্ছে কিনা সেটা শুধু latency দিয়ে বোঝা যায় না।
...
**CI-তে ইভ্যাল।** প্রতিটা PR রিগ্রেশন সেটের ৫০-উদাহরণের সাবসেটের বিরুদ্ধে চলে। ১০ মিনিটের কাজ, "আমরা কি এই সপ্তাহে লঙ্ঘন করেছ" প্রশ্নের উত্তর দেয়। PR ওপেন হলে ১০ মিনিট পরে সবুজ/লাল — এটা ছাড়া কোনো PR মার্জ হয় না, বিল্ডের আগে থেকেই।
...
**রোলব্যাক — একবার ফায়ার-ড্রিল।** রোলব্যাক প্ল্যান ("আগের মডেল ভার্সনে ফিরে যাও", "ওয়ার্কফ্লো ডিজেবল করো", "সব ইনভোকেশন ম্যানুয়ালিতে রাউট করো") থাকা একটা জিনিস। ফায়ার-ড্রিলে এটা একবার রান করা আরেকটা জিনিস। বিল্ডের ডেলিভারেবল: ফায়ার-ড্রিলের তারিখ, কে রান করেছে, কত সময় লেগেছে — লিখিত, সাক্ষীসহ।

**অন-কল — ২+ নাম, ১ প্রাইমারি।** যেকোনো ওয়ার্কফ্লো চললে PagerDuty / টেলিগ্রাম / ফোন কল — যাই হোক — দিয়ে ২+ ইঞ্জিনিয়ার রোটেট করে, ১ জন প্রাইমারি, ১ জন সেকেন্ডারি। একজন ইঞ্জিনিয়ার ছুটিতে গেলে সিস্টেম স্টপ না হওয়াই এটার পয়েন্ট। "কেউ ডিউটি করবে" লেখা যথেষ্ট না, "রাকিব এই সপ্তাহে, তানভীর পরের সপ্তাহে, ব্যাকআপ হাবিব" — এটা যথেষ্ট। রোস্টারে নাম না থাকলে অন-কল মানে সবাই, মানে কেউ না।

---

## যা করবে না

- **মডেল ফাইন-টিউন করবে না।** বিল্ডের উইন্ডোতে না। ফাইন-টিউনিং ডেটা সংগ্রহ, ট্রেনিং, ইভ্যাল, রিগ্রেশন — ৪–৮ সপ্তাহের বিল্ডের সাথে কাজ করে না। ফাইন-টিউনিং একটা [স্কেল](scale.md) পর্বের কাজ, যদি কখনো হয়, যখন ক্রমাগত ইভ্যাল ফেইল হয়।
- **জেনেরিক AI প্ল্যাটফর্ম বানাবে না।** তোমার বিল্ড এই ওয়ার্কফ্লোর জন্য। প্ল্যাটফর্ম কাজ [স্কেল](scale.md)-এ, ৩+ ওয়ার্কফ্লো চললে, ২+ টিম চললে। একটা ওয়ার্কফ্লোতে প্ল্যাটফর্ম বানানো = ওভার-ইঞ্জিনিয়ারিং।
- **অবজার্ভেবিলিটি আর্গুমেন্ট স্কিপ করবে না।** "আমরা পেজ করলে দেখব" — অন-কল ইঞ্জিনিয়ার ভুলে যায়, সিগন্যাল দেখতে দেরি হয়, ব্যবহারকারী আগে ধরে ফেলে। ৫ মিনিটের সেটআপ, ৯০ দিন সাশ্রয় — সহজ অঙ্ক।
- **প্রম্পট চেঞ্জকে রিলিজ ছাড়া করবে না।** প্রম্পট = কোড। একটা PR, একটা CI রান, একটা রিগ্রেশন ইভ্যাল। "আমি দ্রুত একটা ওয়ার্ড বদলে দিলাম" — প্রোডাকশনে অনুমোদিত না, কারণ আজকের ছোট বদল কালকে বড় আচরণ বদলে দিতে পারে।
...
সব সত্য হলে তুমি [স্কেল](scale.md)-এ প্রবেশ করেছ। এক বা একাধিক মিস হলে — বিল্ডে থাকো, ঠিক করো, তারপর এগোও। তাড়াহুড়ো করে স্কেলে ঢুকলে সেই ঘাটতি ১০ গুণ বড় হয়ে ফিরে আসবে — ১টা ওয়ার্কফ্লোতে চাপা পড়া সমস্যা ৫টা ওয়ার্কফ্লোতে বিস্ফোরিত হয়।

---

আরও পড়ার জন্য: [আবিষ্কার](discover.md)-এ ফিরে যাও (বিল্ডের আগে কী হয়েছিল), বা [স্কেল](scale.md)-এ এগোও (বিল্ডের পরে কী হয়)।
