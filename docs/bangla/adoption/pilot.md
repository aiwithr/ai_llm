...
| ফুল অটো — মডেল সিদ্ধান্ত নেয়, মানুষ শুধু অডিট | ইউজার কলান্ত, সিদ্ধান্ত বিপরীতমুখী | কখনো না পাইলটে — সবসময় প্রথম [বিল্ড](build.md) পরবে |
...
- **পার্সিং এরর ধরা পড়ে।** মডেল যদি ভুল শেপের JSON দেয়, পার্সার ধরে — তুমি রিট্রাই করো বা ফলব্যাক পাঠাও।
...
পাইলট সময় LM Studio-তে একটা ডেডিকেটেড হোস্ট ব্যবহার করো — ডেভেলপার ল্যাপটপে ফল্যাপি ওয়ার্কস্টেশনে — কিন্তু **হোস্টেড API-তে ফলব্যাক করবে না**। দুটো কারণে:
...
**ভল পাইলটের চিহ্ন:** তুমি "ভালো দেখাচ্ছে" অনুমব করছো, কিন্তু কোনো সংখ্যা নেই। সংখ্যা ছাড়া ১ সপ্তাহ = ১ সপ্তাহ বেড়ে গেছে।

শ্যাডো মোডে কিছু ব্যর্থতা আসবে — এটা স্বাভাবিক, এটাই পাইলটের কাজ। ব্যর্থতার ধরন ডকুমেন্ট করো, কারণ পাইলটের সিদ্ধান্ত "হ্যাঁ/না/পাইভট"-এর ভিত্তি এই ডেটা। ব্যর্থতা ধরার সবচেয়ে সহজ উপায় হলো প্রতিটা ইনপুট-আউটপুট জোড়া JSONL-এ লগ করা, তারপর সপ্তাহ শেষে স্ক্রিপ্ট দিয়ে অ্যাগ্রিমেন্ট মাপা। লগ ছাড়া শ্যাডো মোড হলো "আমরা মনে হয় ভালো দেখলাম" — সেটা পাইলট না।

একটা কঠিন সত্য: ৫ দিনের শ্যাডো মোডে ১০০% অ্যাগ্রিমেন্ট পাওয়া যাবে না। ৯০% ক্যাটেগরি অ্যাগ্রিমেন্ট হলো ভালো, ৮৫% হলো সীমান্তে, ৮০% এর নিচে হলো "আরো কাজ লাগবে"। কিন্তু এটা আগে থেকে ঠিক করা থাকতে হবে — শ্যাডো সপ্তাহের আগে না হলে শ্যাডো শেষে তুমি "ভালো দেখাচ্ছে" বলবে, যেটা সিদ্ধান্ত না।
...
| **পাইভট** | ডেটা রেসিডেন্সি ঠিক ছিল, কিন্তু ওয়ার্কফ্লো ভল — বা ওয়ার্কফ্লো ঠিক, কিন্তু মডেল সাইজ ভল | [আবিষ্কার](discover.md)-এ ফিরে যাও, একটা ভেরিয়েবল বদলাও, আবার চেষ্টা করো |
...
- **প্রোম্পট ইঞ্জিনিয়ারিং ২ সপ্তাহ ধরে করবে না।** ৩ দিন, ১০ ফিউ-শট, তারপর শ্যাডো। ইঞ্জিনিয়াররা ৫ নম্বর ফিউ-শট চেঞ্জের সবিধা বুঝবে না।
...
"হ্যাঁ" হলে তুমি [বিল্ড](build.md)-এ পরবেশ করেছ।
