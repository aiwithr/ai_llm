...
[বিল্ড](build.md) তোমাকে দিয়েছে একটা টিমের জন্য কাজ করা পাইপলাইন। [পাইলট](pilot.md) তোমাকে দিয়েছে একটা বাস্তব ওয়ার্কফ্লোতে কাজ করা প্রম্পট-পার্সার জোড়া। [আবিষ্কার](discover.md) তোমাকে দিয়েছে সঠিক হার্ডওয়্যার আর ডেটা-রেসিডেন্সি ম্যাপ। কিন্তু স্কেল এর কোনো কিছুরই উত্তরাধিকারী না।
...
স্কেল [বিল্ড](build.md) এর ধারাবাহিকতা না। বিল্ড তোমাকে দেয় ১টা টিমের জন্য ১টা প্রোডাকশন-রেডি সিস্টেম। স্কেল তোমাকে দেয় N টিমের জন্য ১টা **প্ল্যাটফর্ম** — সাথে গভর্নেন্স, খরচ-কন্ট্রোল, মডেল-লাইফসাইকেল। বিল্ড-পরবর্তী সিস্টেম ১০ টিমে কপি করা স্কেল না — সেটা ১০টা আলাদা সিস্টেম, ১০টা আলাদা বাজেট, ১০টা আলাদা বিপদ।
...
[বিল্ড](build.md) শেষে প্রতিটা টিমের কাছে তাদের নিজস্ব প্রম্পট-পার্সার-অবজার্ভেবিলিটি স্ট্যাক আছে। ৫ টিমে এটা ৫ বার লেখা, ৫ বার বাগ ফিক্স, ৫ বার ডকুমেন্ট। স্কেলে তুমি এটাকে **শেয়ার্ড ক্লায়েন্ট প্যাকেজে** রূপান্তর করো — একটা পাইথন প্যাকেজ বা একটা রেপো যেখানে কমন ক্লায়েন্ট, কমন পার্সার, কমন অবজার্ভেবিলিটি হুক আছে। নতুন টিম প্যাকেজ ইনস্টল করে, তাদের নিজস্ব কন্ট্রাক্ট আর প্রম্পট যোগ করে, ১ দিনে শিপ।

কনক্রিট ডেলিভারেবল:

- **`llmkit` (বা যে নামই দাও)** পাইথন প্যাকেজ — `LLMClient`, `PydanticParser`, `MetricsCollector`, `RetryPolicy` সব এখানে। ক্লায়েন্ট-ফেসিং API ইচ্ছাকৃতভাবে সরল: ১টা `complete()` ফাংশন, প্রতিটা টিম বুঝতে পারে ১০ মিনিটে।
...
- **রানবুক** — অন-কল ইঞ্জিনিয়ারের জন্য ১-পৃষ্ঠার ডক: "মডেল ৫০৩ দিচ্ছে? এটা চেক করো।" ৩টা সবচেয়ে কমন সমস্যা, ৩টা ১-লাইনার ফিক্স — রাত ৩টায় যেন অন-কল ইঞ্জিনিয়ার বুঝতে পারে।
...
[আবিষ্কার](discover.md) একটা মডেল বাছাই করিয়েছে, কিন্তু ৬ মাস পরে সেটা সেরা থাকবে না। নতুন ভার্সন আসবে, কোয়ান্টাইজেশন উন্নত হবে, কাজের চাহিদা বদলাবে। CoE-র (Center of Excellence) কাজ হলো **মডেল রেজিস্ট্রি** পরিচালনা করা — কোন মডেল কোন ওয়ার্কফ্লোতে চলছে, কোনটা আপগ্রেডের জন্য প্রস্তুত, কোনটা রোলব্যাক হওয়া উচিত।
...
[পাইলট](pilot.md) ও [বিল্ড](build.md) খরচকে ২-সংখ্যার টেবিল হিসেবে দেখে। ১০ টিমে সেটা ৩-সংখ্যার ক্যাপেক্স প্রশ্ন। স্কেলে তোমার খরচ-কন্ট্রোল ৪টা লিভার:
...
3. **ক্যাশিং।** একই ইনপুট ১০ বার আসলে ১ বার ইনফারেন্স। ট্রায়াজে ২০% ক্যাশ হিট থাকলে ২০% খরচ কম। ক্যাশ কী ধরে রাখবে: সাধারণত ইনপুট-হ্যাশ + আউটপুট, ২৪-৭২ ঘন্টা TTL। ইউজার-স্পেসিফিক ক্যাশ করবে না — গোপনীয়তা ঝুঁকি।
...
**স্টেজ ১ (মাস ১–২) — ভিত্তি:** CoE-র প্রথম কাজ হলো নিজেকে প্রমাণ করা। এই সময়ে তুমি ২-৩ টিমের সাথে কাজ করো, টেমপ্লেট + রেজিস্ট্রি + ড্যাশবোর্ড তৈরি করো, আর ১টা উজ্জ্বল কেস স্টাডি তৈরি করো। "আমরা ৩ সপ্তাহে যেটা করেছি, আগে ৩ মাস লাগত" — এটা CFO-র কাছে দেখানোর উপাদান। ২ মাসে যদি ১টা টিমও ১ দিনে অন-বোর্ড হতে পারে, তাহলে CoE-র বাজেট পরবর্তী FY-তে নিশ্চিত। স্টেজ ১-এর ব্যর্থতা: ৬ মাস পরেও টেমপ্লেট ৫০% সম্পূর্ণ, টিমগুলো নিজেরাই ব্যবহার করে না — তখন CoE অপ্রয়োজনীয় প্রমাণিত হয়।

**স্টেজ ২ (মাস ৩–৪) — অন-বোর্ডিং:** এখন CoE প্রমাণিত, নতুন টিম আসছে। এই স্টেজে তুমি ৪-৭ টিম অন-বোর্ড করো, প্রতিটা টিমের জন্য ওয়ার্কফ্লো-স্পেসিফিক কন্ট্রাক্ট ও প্রম্পট লিখতে সাহায্য করো, ছোট মডেল আপগ্রেড চালাও। সবচেয়ে বড় ঝুঁকি: টেমপ্লেটে ১টা বাগ ধরা পড়লে ৫+ টিমের প্রোডাকশন ভেঙে যায়। CoE-র উত্তর: টেমপ্লেট সিমান্টিক ভার্সনিং (semver), প্রতিটা রিলিজে রিগ্রেশন স্যুট, রোলব্যাক প্ল্যান। স্টেজ ২-এর ব্যর্থতা: ১টা টিমের ভুলে ৪ টিম ক্ষতিগ্রস্ত — টেমপ্লেটের ভরসা ভেঙে যায়, অন-বোর্ডিং থেমে যায়।
...
প্রথম ২ মাসে তুমি কিছু টিমের চাহিদা মেটাও — CoE-র উপর প্রমাণ না আনা পর্যন্ত "আমরা CoE রাখব" বলার সাহস কারো নেই। তৃতীয় স্টেজে CoE প্রমাণিত, এখন কোর্স-কারেকশনের সময়। ষষ্ঠ মাসে ৫+ টিম সক্রিয়ভাবে শেয়ার্ড প্ল্যাটফর্ম ব্যবহার করলে, খরচ প্রতি টিম আগের চেয়ে ৪০% কম হলে — স্কেল সফল।

---

## যা করবে না

- **প্রতিটা টিমের জন্য আলাদা স্ট্যাক বানাবে না।** CoE এর পুরো পয়েন্ট হলো শেয়ার্ড কম্পোনেন্ট। ১০ আলাদা স্ট্যাক = ১০ আলাদা বিপদ।
- **"একটু পরে আপগ্রেড করব" বলবে না।** আপগ্রেড প্ল্যান ছাড়া মডেল পুরনো হয়, সিকিউরিটি প্যাচ মিস হয়, পারফরম্যান্স পিছিয়ে যায়।
- **খরচ রিপোর্ট দেরি করবে না।** মাসিক খরচ রিপোর্ট CFO-র কাছে ১ সপ্তাহের মধ্যে। দেরি হলে CFO নিজে সিদ্ধান্ত নেয় — সাধারণত খরচ কাটা।
- **প্রতিটা টিমের চাহিদায় কাস্টম মডেল বানাবে না।** ১ টিমের জন্য ফাইন-টিউন করা মডেল ৯ টিম ব্যবহার করতে পারে না, CoE-র ভারসাম্য নষ্ট হয়।
- **শেয়ার্ড প্ল্যাটফর্মকে "ফ্রি" ভাববে না।** CoE-র সময়, GPU, লাইসেন্স — এসব খরচ। চার্জব্যাক মডেল ছাড়া CoE বাজেট পায় না।
- **মডেল রেজিস্ট্রি ছাড়া কাজ করবে না।** "আমরা জানি কোন মডেল চলছে" — এটা ৫ টিমে সত্যি, ১০ টিমে মিথ্যা। রেজিস্ট্রি = সত্যের এক জায়গা।
