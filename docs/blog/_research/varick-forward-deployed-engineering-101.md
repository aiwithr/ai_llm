...
Source: https://www.varickagents.com/blog/forward-deployed-engineering-101
...
How to make an agent call a tool: add two tool calls (an API call and a web search) using the Anthropic/OpenAItool use tutorials.
...
How to enforce structured outputs: always return JSON. Read through OpenAI's 
